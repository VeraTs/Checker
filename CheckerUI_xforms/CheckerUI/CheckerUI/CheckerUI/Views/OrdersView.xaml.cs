    ...
    public partial class OrdersView : ContentPage
    {
        ...
        private void TapGestureRecognizer_OnTapped(object sender, EventArgs e)
        {
            ...
            stackLayout.BackgroundColor = Color.Gray;
             if (lastStackLayout != null){ lastStackLayout.BackgroundColor = Color.White;}
        ...
        private async void TapGestureRecognizer_OnDoubleTapped(object sender, EventArgs e)
        {
            ...
            if (Zones.SelectedItem is ServingZone item && ((OrdersViewModel)BindingContext).PickUpItemForServing(item.id).Result)
            {
